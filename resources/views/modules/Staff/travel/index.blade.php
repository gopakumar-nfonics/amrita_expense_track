                        ...
                        <table class="table table-row-dashed table-row-gray-300 align-middle gs-0 gy-4" id="userstable">
                            <thead>
                                <tr class="fw-bold">
                                    ...
                                    <th class="min-w-100px">Advance (&#x20b9;)</th>
                                    ...
                                    <td>
                                        ...
                                        <div class="d-flex align-items-center">
                                            <div class="fw-400 d-block fs-6">
                                                ...
                                                {!! $expense->amount > 0
                                                ? '<span
                                                    class="fs-2 fw-semibold text-gray-500 align-self-start me-0">&#x20b9;</span><span class="total-cost-span fs-2 fw-bold text-gray-800 me-2 lh-1 ls-n2">' . $expense->amount . '</span>'
                                                : 'NA'
                                                !!}
                                            </div>
                                        </div>
                                    ...
                                    <td>
                                        ...
                                        <div class="d-flex align-items-center">
                                            <div class="fw-400 d-block fs-6">
                                                ...
                                                <span
                                                    class="total-cost-span fs-2 fw-bold text-gray-800 me-2 lh-1 ls-n2"> {{ $expense->advance_amount }}</span>
                                            </div>
                                        </div>
                                    </td>
                                    <td>
                                        ...
                                        <div class="d-flex flex-column w-100 me-2">
                                            <div class="d-flex flex-stack mb-0">
                                                <span
                                                    class=" me-2 fs-5 fw-bold">100%</span>
                                            </div>
