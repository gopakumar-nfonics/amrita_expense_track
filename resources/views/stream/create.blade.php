				...
				<div class="card mb-5 mb-xl-10">
					...
					<div class="card-header border-0 cursor-pointer" role="button" data-bs-toggle="collapse" data-bs-target="#kt_account_profile_details" aria-expanded="true" aria-controls="kt_account_profile_details">
						...
						<div class="card-title m-0">
							<h3 class="fw-bold m-0">Create Programme</h3>
						</div>
						<!--end::Card title-->
					</div>
					<!--begin::Card header-->
							...
							<div class="card-body border-top p-9">
									...
									<div class="col-lg-8 fv-row">
										...
										<div class="col-lg-12 fv-row">
											<select class="form-select mb-2 @error('campus') is-invalid @enderror" data-control="select2" data-hide-search="true" data-placeholder="Select Campus" name="campus" id="campus">
												...
												<option value="{{$cmps->id}}" @if(old('campus')==$cmps->id) selected @endif>{{$cmps->campus_name}}</option>
												@endforeach
								...
								<div class="row mb-6">
														...
														<div class="col-lg-8 fv-row">
															<!--begin::Col-->
															<div class="col-lg-12 fv-row">
																<textarea name="billingaddress" id="billingaddress" class="form-control form-control-lg form-control-solid @error('billingaddress') is-invalid @enderror" placeholder="Address">{{ old('billingaddress') }}</textarea>
