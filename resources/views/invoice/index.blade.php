	...
	<div id="kt_app_toolbar" class="app-toolbar py-3 py-lg-6">
		...
		<div id="kt_app_toolbar_container" class="app-container container-xxl d-flex flex-stack">
			...
			<div class="page-title d-flex flex-column justify-content-center flex-wrap me-3">
				<!--begin::Title-->
				<h1 class="page-heading d-flex text-dark fw-bold fs-3 flex-column justify-content-center my-0">Invoice Listing</h1>
				<!--end::Title-->
				<!--begin::Breadcrumb-->
								...
								<tr>
									...
									<div class="d-flex align-items-center">
                                            <div class="symbol symbol-35px me-2">
                                                <span class="symbol-label bg-blue text-white">{{$inv->vendor->vendor_name[0]}}{{$inv->vendor->vendor_name[strlen($inv->vendor->vendor_name) - 1]}}</span>
									...
									<td>
										<div class="d-flex align-items-center">
											<div class="fw-400 d-block fs-6">
												&#x20b9;{{$inv->milestone->milestone_total_amount}}
											</div>
										</div>
									</td>
									...
									<td class="text-center">
										...
										<div class="menu menu-sub menu-sub-dropdown menu-column menu-rounded menu-gray-600 menu-state-bg-light-primary fw-semibold fs-7 w-150px py-4" data-kt-menu="true">
											...
											<div class="menu-item px-3">
												<a href="{{ route('payment.create',$inv->id) }}" class="menu-link px-3">Proceed Payment</a>
											</div>
											@endif
											<!--end::Menu item-->
											<!--begin::Menu item-->
