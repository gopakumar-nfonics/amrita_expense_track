                                ...
                                <div style="text-align:center; margin:0 15px 0px 15px">
                                    ...
                                    <div
                                        ...
                                        <p style="margin-bottom:20px; color:#777;margin-top:20px;">
                                            We are pleased to inform you that your travel expense for the trip
                                            {{ $details['expense_title'] }}
                                            has been reviewed and successfully settled.</p>
                                        <p style="margin-bottom:20px; color:#777">The final amount has been processed
                                            based on the submitted details.</p>
                        ...
                        <tr>
                            <td align="center" valign="center"
                                ...
                                <p style="margin-bottom:4px">You may reach us at
                                    <a href="h#" rel="noopener" target="_blank"
