						...
						<div class="w-lg-500px p-10">
                            ...
                            @csrf
								...
								<div class="text-center mb-15">
									...
									<h2 class="text-grey-200 fw-bolder mt-2 pt-3 br-b-1">Password Reset</h2>
									<!--end::Title-->
									<!--begin::Subtitle-->
								...
								<!--begin::Heading-->
								<div class="text-dark text-center mb-8">Please enter your email address and we'll send you a link to reset your password</div>
