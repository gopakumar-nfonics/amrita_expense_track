                            ...
                            <td align="center" valign="center" style="text-align:center; padding-bottom: 10px">
                                ...
                                <div style="text-align:center; margin:0 15px 0px 15px">
                                    ...
                                    <div
                                        ...
                                        <p style="margin:20px 15px; color:#333;margin-top:20px;">
                                            We are pleased to inform you that your proposal for the
                                            {{$details['proposal_title']}} has been approved. We appreciate the effort
                                            and detailed SoW you have submitted.</p>
                                        <p style="margin:20px 15px; color:#333">
                                            As part of this approval, we have generated a Release Order, that can be
                                            downloaded by clicking the link below. Please review the document carefully,
                                            and let us know if you have any questions or need further clarification.</p>

                                        <!--begin:Action-->
                                        <p style="margin:0px;padding:0px;text-align:center;">
                                            <a href="{{ $details['releaseorderUrl'] }}"
                                                download="{{ $details['releaseorderUrl'] }}"
                                                download="{{ $details['releaseorderUrl'] }}"
