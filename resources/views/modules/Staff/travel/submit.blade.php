                                    ...
                                    <div class="row gx-10 mb-5">
                                        ...
                                        <div class="table-responsive mb-10 col-lg-12">
                                            <div class="min-h-300px me-10 mt-10">
                                                ...
                                                <div class="text-muted fs-7 mb-5">Add all travel-related expenses, including transportation, accommodation, meals, and other associated costs.</div>
                                                        ...
                                                        <tr
                                                            ...
                                                            <th colspan="4"
                                                                ...
                                                                <div class="d-flex flex-column align-items-end">
                                                                    <div>
                                                                        <span
                                                                            class="fs-2 fw-bold text-gray-500 me-2 ">
                                                                            Total :
                                                                        </span>
                                                                        <span
