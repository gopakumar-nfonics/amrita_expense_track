        ...
        <div id="kt_app_toolbar" class="app-toolbar py-3 py-lg-6">
            ...
            <div id="kt_app_toolbar_container" class="app-container container-xxl d-flex flex-stack">
                ...
                <div class="card-toolbar">
                    <a href="{{ route('dailyallowanceaccommodation.create') }}" class="btn btn-sm btn-primary">
                        Create
                    </a>
                </div>
            </div>
                            ...
                            <table class="table table-row-dashed table-row-gray-300 align-middle gs-0 gy-4" id="userstable">
                                <thead>
                                    <tr class="fw-bold">
                                        ...
                                        <th class="min-w-100px">City Tier</th>
                                        <th class="min-w-100px">Allowance</th>
                                    ...
                                    @forelse($records as $key => $record)
                                        <tr>
                                            ...
                                            <td>
                                                <div class="d-flex align-items-center">
                                                    <div class="fw-400 d-block fs-6">
                                                        &#8377;{{ number_format($record->accommodation_amount, 2) }}
                                                    </div>
                                                </div>
                                            </td>
                                            <td class="text-center">
                                                ...
                                                <div class="menu menu-sub menu-sub-dropdown menu-column menu-rounded menu-gray-600 menu-state-bg-light-primary fw-semibold fs-7 w-125px py-4"
                                                    ...
                                                    <div class="menu-item px-3">
                                                        <a href="{{ route('dailyallowanceaccommodation.edit', $record->id) }}"
...
@section('pageScripts')
    ...
    <script>
        function removeData(dataId) {
            swal({
                    title: "Are you sure?",
                    text: "You want to remove this DA & Accommodation",
                    icon: "warning",
                    buttons: true,
                    dangerMode: true,
                })
                .then((willDelete) => {
                    if (willDelete) {
                        $.ajax({
                            url: "/dailyallowanceaccommodation/" + dataId,
                            type: 'DELETE',
                            data: {
                                _token: '{{ csrf_token() }}',
                            },
