                            ...
                            <div class="d-flex flex-column gap-7 gap-md-10">
                                ...
                                <div class="d-flex justify-content-between flex-column">
                                    ...
                                    <div class="table-responsive border-bottom mb-9">
                                        ...
                                        <div class="m-5">
                                            <table class="table align-middle table-row-dashed fs-6 gy-5 mb-0">
                                                ...
                                                <tbody class="fw-semibold text-gray-600">
                                                    ...
                                                    <tr>
                                                        <td></td>
                                                        <td colspan="2" class="text-dark fw-bolder text-sm-end pb-0 ">
                                                            <span class="fs-5 fw-bold text-gray-800 txt-uppercase">
                                                                Advance Paid :
                                                            </span>
                                                        </td>
                                                        <td colspan="" class="text-dark fw-bolder text-end fs-5 pb-0 "
                                        ...
                                        <tr>
                                            <td></td>
                                            <td colspan="2" class="text-dark fw-bolder text-sm-end fs-2  py-0">
                                                <span class="fs-5 fw-bold text-gray-800 txt-uppercase">
                                                    Total Claimed :
                                                </span>
                                            </td>
                                            <td colspan="" class="text-dark fw-bolder text-end fs-2  py-0"
                                                style="font-size:18px !important;">
                                                <div>
                                                    <span
                                                        class="fs-3 fw-semibold text-gray-500 align-self-start me-1">
                                    ...
                                    <tr>
                                        <td></td>
                                        <td colspan="2" class="text-dark fw-bolder text-sm-end fs-3 py-0  br-0">
                                            <span class="fs-5 fw-bold text-info txt-uppercase">
                                                Amount to be Settled :
                                            </span>
                                        </td>
                                        <td colspan="" class="text-dark fw-bolder text-end fs-2 py-0 br-0"
                                            style=" font-size:18px !important;">
                                            <div>
                                                <span
