...
<div class="d-flex flex-column flex-column-fluid">
	...
	<div id="kt_app_content" class="app-content flex-column-fluid">
		...
		<div id="kt_app_content_container" class="app-container container-xxl">
			<!--begin::Form-->
			<form action="{{ route('email-config.store') }}" method="POST" id="email_config_form" class="form d-flex flex-column flex-lg-row">
				@csrf
				<!--begin::Main column-->
						...
						<div class="card-body border-top p-9">
							...
							<div class="mb-10 fv-row">
								...
								<select name="email_type" class="form-select mb-2" data-control="select2" data-hide-search="false" data-placeholder="Select email type" data-allow-clear="true">
									<option></option>
									<option value="budget_report" {{ old('email_type') == 'budget_report' ? 'selected' : '' }}>Budget Report</option>
									<option value="expense_notification" {{ old('email_type') == 'expense_notification' ? 'selected' : '' }}>Expense Notification</option>
									<option value="system_alerts" {{ old('email_type') == 'system_alerts' ? 'selected' : '' }}>System Alerts</option>
									<option value="payment_updates" {{ old('email_type') == 'payment_updates' ? 'selected' : '' }}>Payment Updates</option>
								</select>
								<!--end::Input-->
								<!--begin::Description-->
							...
							<div class="row mb-10">
								<div class="col-md-6 fv-row">
									...
									<!--end::Label-->
									<!--begin::Input-->
									<input type="email" name="email_address" class="form-control mb-2" placeholder="Enter email address" value="{{ old('email_address') }}">
									<!--end::Input-->
									<!--begin::Description-->
								...
								<div class="col-md-6 fv-row">
									...
									<!--end::Label-->
									<!--begin::Input-->
									<input type="text" name="recipient_name" class="form-control mb-2" placeholder="Enter recipient name" value="{{ old('recipient_name') }}">
									<!--end::Input-->
									<!--begin::Description-->
							...
							<!--end::Input group-->
							<!--begin::Hidden input for active status-->
							<input type="hidden" name="is_active" value="1">
							<!--end::Hidden input for active status-->
						</div>
						<!--end::Card body-->
					</div>
					<!--end::General options-->
