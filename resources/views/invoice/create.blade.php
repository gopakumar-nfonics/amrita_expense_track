		...
		<div id="kt_app_toolbar" class="app-toolbar py-3 py-lg-6">
			...
			<div id="kt_app_toolbar_container" class="app-container container-xxl d-flex flex-stack">
				...
				<div class="page-title d-flex flex-column justify-content-center flex-wrap me-3">
					<!--begin::Title-->
					<h1 class="page-heading d-flex text-dark fw-bold fs-3 flex-column justify-content-center my-0">Submit Invoice</h1>
					<!--end::Title-->
					<!--begin::Breadcrumb-->
								...
								<form action="" id="kt_invoice_form">
									...
									<div class="mb-0">
										...
										<div class="fv-row  d-flex justify-content-between">
													...
													<div class="fv-row  d-flex justify-content-between mt-7">
															...
															<div class="text-center">
																		<button type="button" class="btn btn-sm btn-info w-100 mt-5 mb-1" data-bs-toggle="modal" data-bs-target="#kt_modal_upload">
																			...
																			<!--end::Svg Icon-->Upload Invoice</button>
																	</div>

																	<!--begin::Description-->
																	<div class="text-muted fs-7 text-center">Upload reference invoice.</div>
																	<!--end::Description-->
