                                ...
                                <div class="d-flex flex-row flex-center">
                                    ...
                                    <div class="border border-gray-300 border-dashed rounded py-3 px-3 mb-3">
                                        <div class="fs-6 fw-bold text-gray-700">
                                            <span
                                                class="w-75px">&#x20b9;{{ number_format($totalProposalAmount, 2) }}</span>
                                        </div>
                                    ...
                                    <div class="d-flex justify-content-md-start fs-6 py-3">
                                        ...
                                        <div class="flex-column mb-0 w-300px">
                                            ...
                                            <div class="text-gray-600">
                                                <a href="#"
                                                    class="text-gray-600 text-hover-primary">{{$vendor->email}}</a>
                                            </div>
                                        </div>
                                        <div class="flex-column mb-0">
                                            ...
                                            <div class="text-gray-600">
                                                <a href="#"
                                                    class="text-gray-600 text-hover-primary">{{$vendor->phone}}</a>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="d-flex justify-content-md-start fs-6 py-3">
                                        ...
                                        <div class="flex-column mb-0">
                                            ...
                                            <div class="text-gray-600">
                                                <a href="#"
                                                    class="text-gray-600 text-hover-primary">{{$vendor->pan}}</a>
                                            </div>
                                        </div>
                                        ...
                                        <div class="table-responsive">
                                            ...
                                            <table
                                                ...
                                                <tbody>
                                                    ...
                                                    @php
                                                    $paidPercentage = $proposal['total_proposal_amount'] > 0 ?
                                                    ($proposal['total_paid_amount'] /
                                                    $proposal['total_proposal_amount']) * 100 : 0;
                                                    ...
                                                    <tr>
                                                                    ...
                                                                    <span
                                                                        ...
                                                                        <span
                                                                            ...
                                                                            <span
                                                                                ...
                                                                                <i
                                                                                    class="fa-solid fa-arrow-up light-green fs-8 me-1 "></i>
                                                                            </span>
                                                                            <!--end::Svg Icon-->{{$paidPercentage}}%
                                                                        </span>
                                                                    </span>
                                                        ...
                                                        <td>
                                                            <div class="d-flex align-items-center">
                                                                <div class="fw-400 d-block fs-6">
                                                                    ...
                                                                    <span
                                                                        class="total-cost-span fs-2 fw-bold text-gray-800 me-2 lh-1 ls-n2">{{ number_format($proposal['total_proposal_amount'], 2) }}</span>
                                                                </div>
                                                            </div>
                                                            ...
                                                            <div class="d-flex align-items-center">
                                                                <div class="fw-400 d-block fs-6">
                                                                    <span
                                                                        class="fs-2 fw-semibold text-gray-500 align-self-start me-0">&#x20b9;</span>
                                                                    <span
                                                                        class="total-cost-span fs-2 fw-bold text-gray-800 me-2 lh-1 ls-n2">{{ number_format($proposal['total_paid_amount'], 2) }}</span>
                                                                </div>
                                                            </div>
                                                        ...
                                                        <td>
                                                            @php
                                                            $probalanceAmount = $proposal['total_proposal_amount'] -
                                                            $proposal['total_paid_amount'];
                                                            @endphp
                                                            ...
                                                            <div class="d-flex align-items-center">
                                                                <div class="fw-400 d-block fs-6">
                                                                    <span
                                                                        class="fs-2 fw-semibold text-gray-500 align-self-start me-0">&#x20b9;</span>
                                                                    <span
                                                                        class="total-cost-span fs-2 fw-bold text-gray-800 me-2 lh-1 ls-n2">{{ number_format($probalanceAmount, 2) }}</span>
                                                                </div>
                                                            </div>
                                                        </td>
                            ...
                            <form id="kt_modal_add_payment_form" class="form fv-plugins-bootstrap5 fv-plugins-framework"
                                ...
                                <div class="fv-row mb-7 fv-plugins-icon-container">
                                    ...
                                    <label class="fs-6 fw-semibold form-label mb-2">
                                        ...
                                        <i class="fas fa-exclamation-circle ms-1 fs-7" data-bs-toggle="tooltip"
                                            aria-label="The invoice number must be unique." data-kt-initialized="1"></i>
                                    </label>
                                    <!--end::Label-->
                                    <!--begin::Input-->
                                ...
                                <div class="fv-row mb-7 fv-plugins-icon-container">
                                    ...
                                    <select class="form-select form-select-solid fw-bold select2-hidden-accessible"
                                        ...
                                        data-hide-search="true" data-select2-id="select2-data-10-7x1n" tabindex="-1"
                                        ...
                                        dir="ltr" data-select2-id="select2-data-11-mu62" style="width: 100%;"><span
                                            class="selection"><span
                                                class="select2-selection select2-selection--single form-select form-select-solid fw-bold"
                                                role="combobox" aria-haspopup="true" aria-expanded="false" tabindex="0"
                                                aria-disabled="false" aria-labelledby="select2-status-xv-container"
                                                aria-controls="select2-status-xv-container"><span
                                                    class="select2-selection__rendered" id="select2-status-xv-container"
                            ...
                            <form id="kt_modal_adjust_balance_form"
                                ...
                                <div class="fv-row mb-7 fv-plugins-icon-container">
                                    ...
                                    <select class="form-select form-select-solid fw-bold select2-hidden-accessible"
                                        ...
                                        data-select2-id="select2-data-13-zqig" tabindex="-1" aria-hidden="true"
                                        data-kt-initialized="1">
                                        <option data-select2-id="select2-data-15-w3a7"></option>
                                        <option value="1">Credit</option>
                                        <option value="2">Debit</option>
                                    </select><span class="select2 select2-container select2-container--bootstrap5"
                                        dir="ltr" data-select2-id="select2-data-14-mc3o" style="width: 100%;"><span
                                            class="selection"><span
                                                class="select2-selection select2-selection--single form-select form-select-solid fw-bold"
                                                role="combobox" aria-haspopup="true" aria-expanded="false" tabindex="0"
                                                aria-disabled="false" aria-labelledby="select2-adjustment-0m-container"
                                                aria-controls="select2-adjustment-0m-container"><span
                                                    class="select2-selection__rendered"
                                                    id="select2-adjustment-0m-container" role="textbox"
                        ...
                        <form class="form" action="#" id="kt_modal_update_customer_form">
                            ...
                            <div class="modal-body py-10 px-lg-17">
                                ...
                                <div class="d-flex flex-column scroll-y me-n7 pe-7" id="kt_modal_update_customer_scroll"
                                    ...
                                    data-kt-scroll-offset="300px" style="max-height: 307px;">
                                    <!--begin::Notice-->
                                    <!--begin::Notice-->
                                    <div
                                    ...
                                    <div id="kt_modal_update_customer_billing_info" class="collapse">
                                        ...
                                        <div class="d-flex flex-column mb-7 fv-row">
                                            ...
                                            <select name="country" aria-label="Select a Country" data-control="select2"
                                                ...
                                                data-select2-id="select2-data-16-cddz" tabindex="-1" aria-hidden="true"
                                                data-kt-initialized="1">
                                                <option value="" data-select2-id="select2-data-18-htca">Select a
                                                    Country...</option>
                                                ...
                                                dir="ltr" data-select2-id="select2-data-17-rlhk"
                                                style="width: 100%;"><span class="selection"><span
                                                        class="select2-selection select2-selection--single form-select form-select-solid fw-bold"
                                                        role="combobox" aria-haspopup="true" aria-expanded="false"
                                                        tabindex="0" aria-disabled="false"
                                                        aria-labelledby="select2-country-68-container"
                                                        aria-controls="select2-country-68-container"><span
                                                            class="select2-selection__rendered"
                                                            id="select2-country-68-container" role="textbox"
                                ...
                                <div class="row mb-10">
                                        ...
                                        <div class="row fv-row fv-plugins-icon-container">
                                            ...
                                            <div class="col-6">
                                                <select name="card_expiry_month"
                                                    ...
                                                    data-placeholder="Month" data-select2-id="select2-data-19-670l"
                                                    ...
                                                    class="select2 select2-container select2-container--bootstrap5"
                                                    dir="ltr" data-select2-id="select2-data-20-0bal"
                                                    style="width: 100%;"><span class="selection"><span
                                                            class="select2-selection select2-selection--single form-select form-select-solid"
                                                            role="combobox" aria-haspopup="true" aria-expanded="false"
                                                            tabindex="0" aria-disabled="false"
                                                            aria-labelledby="select2-card_expiry_month-j9-container"
                                                            aria-controls="select2-card_expiry_month-j9-container"><span
                                                                class="select2-selection__rendered"
                                                                id="select2-card_expiry_month-j9-container"
                                                                role="textbox" aria-readonly="true" title="Month"><span
                                            ...
                                            <div class="col-6">
                                                <select name="card_expiry_year"
                                                    class="form-select form-select-solid select2-hidden-accessible"
                                                    data-control="select2" data-hide-search="true"
                                                    data-placeholder="Year" data-select2-id="select2-data-22-indi"
                                                    tabindex="-1" aria-hidden="true" data-kt-initialized="1">
                                                    ...
                                                    class="select2 select2-container select2-container--bootstrap5"
                                                    dir="ltr" data-select2-id="select2-data-23-0wac"
                                                    style="width: 100%;"><span class="selection"><span
                                                            class="select2-selection select2-selection--single form-select form-select-solid"
                                                            role="combobox" aria-haspopup="true" aria-expanded="false"
                                                            tabindex="0" aria-disabled="false"
                                                            aria-labelledby="select2-card_expiry_year-dp-container"
                                                            aria-controls="select2-card_expiry_year-dp-container"><span
                                                                class="select2-selection__rendered"
                                                                id="select2-card_expiry_year-dp-container"
                                                                role="textbox" aria-readonly="true" title="Year"><span
                                    ...
                                    <div class="col-md-4 fv-row fv-plugins-icon-container">
                                        ...
                                        <label class="d-flex align-items-center fs-6 fw-semibold form-label mb-2">
                                            ...
                                            <i class="fas fa-exclamation-circle ms-2 fs-7" data-bs-toggle="tooltip"
                                                aria-label="Enter a card CVV code" data-kt-initialized="1"></i>
                                        </label>
                                        <!--end::Label-->
                                        <!--begin::Input wrapper-->
                                        <div class="position-relative">
