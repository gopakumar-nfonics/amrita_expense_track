                    ...
                    <div class="app-sidebar-menu overflow-hidden flex-column-fluid">
                        ...
                        <div id="kt_app_sidebar_menu_wrapper" class="app-sidebar-wrapper hover-scroll-overlay-y my-5"
                            ...
                            <div class="menu menu-column menu-rounded menu-sub-indention px-3" id="#kt_app_sidebar_menu"
                                ...
                                <div data-kt-menu-trigger="click"
                                    ...
                                    <div class="menu-sub menu-sub-accordion">
                                        ...
                                        <div class="menu-item">
                                            ...
                                            <a class="menu-link @if (in_array(Route::currentRouteName(), ['invoice.index'])) active @endif"
                                ...
                                <!--begin:Menu item-->
                                <div data-kt-menu-trigger="click"
                                    class="menu-item menu-accordion @if (in_array(Route::currentRouteName(), ['lead.index', 'lead.create'])) show @endif">
                                    <!--begin:Menu link-->
                                    <span class="menu-link">
                                        <span class="menu-icon">
                                    ...
                                    <div class="menu-sub menu-sub-accordion">
                                        ...
                                        <div class="menu-item">
                                            ...
                                            <a class="menu-link @if (in_array(Route::currentRouteName(), ['lead.index'])) active @endif"
                                ...
                                @if (Auth::user()->isAdmin() || Auth::user()->isExpenseManager())
                                    ...
                                    <!--begin:Menu item-->
                                    <div data-kt-menu-trigger="click"
                                        class="menu-item menu-accordion @if (in_array(Route::currentRouteName(), ['email-config.index', 'email-config.create', 'email-config.edit', 'email-config.show'])) show @endif">
                                        <!--begin:Menu link-->
                                        <span class="menu-link">
                                            <span class="menu-icon">
                                                <i class="fa-solid fa-envelope-circle-check f-15 p-0"></i>
                                            </span>
                                        ...
                                        <div class="menu-sub menu-sub-accordion">
                                            ...
                                            <div class="menu-item">
                                                <!--begin:Menu link-->
                                                <a class="menu-link @if (in_array(Route::currentRouteName(), ['email-config.index'])) active @endif"
                                                    href="{{ route('email-config.index') }}">
                                                    <span class="menu-bullet">
                                                        <span class="bullet bullet-dot"></span>
                                                    </span>
                                                    <span class="menu-title">Email List</span>
                                                </a>
                                                <!--end:Menu link-->
                                            </div>
                                            <!--end:Menu item-->
                                            ...
                                            <div class="menu-item">
                                                <!--begin:Menu link-->
                                                <a class="menu-link @if (in_array(Route::currentRouteName(), ['email-config.create'])) active @endif"
                                                    href="{{ route('email-config.create') }}">
                                                    <span class="menu-bullet">
                                                        <span class="bullet bullet-dot"></span>
                                                    </span>
                                                    <span class="menu-title">Add Email</span>
                                                </a>
                                                <!--end:Menu link-->
                                            </div>
                                            <!--end:Menu item-->
