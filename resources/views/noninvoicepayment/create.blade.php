                    ...
                    <div class="flex-lg-row-fluid mb-10 mb-lg-0 me-lg-7 me-xl-10">
                        ...
                        <div class="card">
                            ...
                            <div class="card-body p-12">
                                ...
                                <!--begin::Form-->
                                <form id="kt_invoice_form" method="POST" action="{{route('noninvoicepayment.store')}}"
                                                            ...
                                                            <select
                                                                ...
                                                                <optgroup label="{{ $main_category->category_name }}">
                                                                    ...
                                                                    <option class="sub-category"
                                                                        ...
                                                                        @if(old('category')==$subcategory->id) selected
                                                                        @endif>
                                                                ...
                                                                <option class="main-category"
                                                                    ...
                                                                    @if(old('category')==$main_category->id) selected
                                                                    @endif>
                                                ...
                                                <div class="col-lg-12">
                                                    <div class="fv-row  d-flex justify-content-start gap-10">
                                                        ...
                                                        <div class="fs-6 fw-bold text-gray-700 col-lg-8">
                                                            ...
                                                            <input type="text" name="remarks" class="form-control form-control-lg @error('remarks') is-invalid @enderror" placeholder="Remarks" value="{{ old('remarks') }}" />
                                                    ...
                                                    <div
                                                        ...
                                                        <span class="color-blue"></span><span
