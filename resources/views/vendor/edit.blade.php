			...
			<div id="kt_app_content_container" class="app-container container-xxl">
				...
				<div class="card mb-5 mb-xl-10">
					...
					<div id="kt_account_settings_profile_details" class="collapse show">
						<!--begin::Form-->
						<form id="kt_account_profile_details_form" class="form" method="POST" action="{{route('vendor.update',$vendor->id)}}" enctype="multipart/form-data">
							@csrf
							@method('PUT')
							<!--begin::Card body-->
							<div class="card-body border-top p-9">
								...
								<label class="col-lg-2 col-form-label fw-semibold fs-6">Code</label>
									...
									<div class="col-lg-4 fv-row">
										...
										<div class="fw-bold fs-6 pt-3">{{$vendor->vendor_code}}</div>
											<input type="hidden" name="code" value="{{$vendor->vendor_code}}" />
										</div>
										<!--end::Col-->
									</div>
									<!--begin::Label-->
									...
									<div class="col-lg-4 fv-row">
										<!--begin::Col-->
										<div class="col-lg-12 fv-row">
											<input type="text" name="name" class="form-control form-control-lg form-control-solid @error('name') is-invalid @enderror" placeholder="Name" value="{{ old('name', $vendor->vendor_name) }}" />
									...
									<div class="col-lg-6 fv-row">
										<select class="form-control form-control-lg form-control-solid @error('company') is-invalid @enderror" id="company" name="company">
											<option value="">--Select Company--</option>
												...
												@if(old('company',$vendor->company_id) == $company->id) selected @endif>{{ $company->company_name }}</option>
                                                @endforeach
										</select>
										@error('company')
								...
								<div class="row mb-6">
									...
									<div class="col-lg-4 fv-row">
										<!--begin::Col-->
										<div class="col-lg-12 fv-row">
											<input type="text" name="phone" class="form-control form-control-lg form-control-solid @error('phone') is-invalid @enderror" placeholder="Phone Number" value="{{ old('phone', $vendor->phone) }}" />
								...
								<div class="row mb-6">
									...
									<div class="col-lg-4 fv-row">
										<!--begin::Col-->
										<div class="col-lg-12 fv-row">
											<input type="text" name="gst" class="form-control form-control-lg form-control-solid @error('gst') is-invalid @enderror" placeholder="GST #" value="{{ old('gst', $vendor->gst) }}" />
									...
									<div class="col-lg-4 fv-row">
										<!--begin::Col-->
										<div class="col-lg-12 fv-row">
											<input type="text" name="pan" class="form-control form-control-lg form-control-solid @error('pan') is-invalid @enderror" placeholder="PAN #" value="{{ old('pan', $vendor->pan) }}" />
								...
								<div class="row mb-6">
									...
									<div class="col-lg-10 fv-row">
										<!--begin::Col-->
										<div class="col-lg-12 fv-row">
											<textarea name="address" class="form-control form-control-lg form-control-solid @error('address') is-invalid @enderror" placeholder="Address">{{ old('address', $vendor->address) }}</textarea>
