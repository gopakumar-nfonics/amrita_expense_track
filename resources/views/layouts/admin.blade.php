								...
								<div class="menu menu-column menu-rounded menu-sub-indention px-3" id="#kt_app_sidebar_menu" data-kt-menu="true" data-kt-menu-expand="false">
									...
									<div data-kt-menu-trigger="click" class="menu-item menu-accordion @if(in_array(Route::currentRouteName(),array('department.index','department.create'))) show  @endif">
										...
										<div class="menu-sub menu-sub-accordion">
											...
											<div class="menu-item">
												<!--begin:Menu link-->
												<a class="menu-link @if(in_array(Route::currentRouteName(),array('department.index'))) active  @endif" href="{{route('department.index')}}">
													<span class="menu-bullet">
														<span class="bullet bullet-dot"></span>
													</span>
											...
											<div class="menu-item">
												<!--begin:Menu link-->
												<a class="menu-link  @if(in_array(Route::currentRouteName(),array('department.create'))) active  @endif" href="{{route('department.create')}}">
													<span class="menu-bullet">
														<span class="bullet bullet-dot"></span>
													</span>
